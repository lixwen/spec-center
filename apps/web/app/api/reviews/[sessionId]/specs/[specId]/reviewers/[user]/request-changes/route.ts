import { reviewerRequestChangesForSpec } from "@spec-center/core";
...
export async function POST(
  ...
  try {
    ...
    return ok(await reviewerRequestChangesForSpec(sessionId, specId, decodeURIComponent(user), actor));
  } catch (error) {
    return fail(error);
  }
}
